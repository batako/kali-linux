...
**Custom commands in this repo** → [COMMAND.en.md](COMMAND.en.md)

日本語: [CHEATSHEET.md](CHEATSHEET.md)
...
Container automation → [COMMAND.en.md](COMMAND.en.md) (`sshkey-crack`, `hydrassh`, etc.).
...
Automated → [COMMAND.en.md](COMMAND.en.md) `steg-extract` (alias: `stegx`).
